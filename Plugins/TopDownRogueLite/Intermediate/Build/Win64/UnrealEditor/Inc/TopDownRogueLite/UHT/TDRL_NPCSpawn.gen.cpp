...
void FOnSpawnedDeathDelegate_DelegateWrapper(const FMulticastScriptDelegate& OnSpawnedDeathDelegate, FDeathData DeathData)
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_Projects_Che_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Gameplay_TDRL_NPCSpawn_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_Che_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Gameplay_TDRL_NPCSpawn_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_Che_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Gameplay_TDRL_NPCSpawn_h_19847477(TEXT("/Script/TopDownRogueLite"),
		Z_CompiledInDeferFile_FID_Unreal_Projects_Che_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Gameplay_TDRL_NPCSpawn_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_Che_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Gameplay_TDRL_NPCSpawn_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
