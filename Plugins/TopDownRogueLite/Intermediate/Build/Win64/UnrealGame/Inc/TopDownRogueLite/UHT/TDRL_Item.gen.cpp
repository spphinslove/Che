...
// Cross Module References
	...
	TOPDOWNROGUELITE_API UFunction* Z_Construct_UDelegateFunction_TopDownRogueLite_OnInteractedDelegate__DelegateSignature();
...
// End Cross Module References
	struct Z_Construct_UDelegateFunction_TopDownRogueLite_OnInteractedDelegate__DelegateSignature_Statics
	{
		struct _Script_TopDownRogueLite_eventOnInteractedDelegate_Parms
		{
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_TopDownRogueLite_OnInteractedDelegate__DelegateSignature_Statics::NewProp_InteractingCharacter = { "InteractingCharacter", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_TopDownRogueLite_eventOnInteractedDelegate_Parms, InteractingCharacter), Z_Construct_UClass_ATDRL_Character_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_TopDownRogueLite_OnInteractedDelegate__DelegateSignature_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_TopDownRogueLite_OnInteractedDelegate__DelegateSignature_Statics::NewProp_InteractingCharacter,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_TopDownRogueLite_OnInteractedDelegate__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Items/TDRL_Item.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_TopDownRogueLite_OnInteractedDelegate__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_TopDownRogueLite, nullptr, "OnInteractedDelegate__DelegateSignature", nullptr, nullptr, sizeof(Z_Construct_UDelegateFunction_TopDownRogueLite_OnInteractedDelegate__DelegateSignature_Statics::_Script_TopDownRogueLite_eventOnInteractedDelegate_Parms), Z_Construct_UDelegateFunction_TopDownRogueLite_OnInteractedDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_TopDownRogueLite_OnInteractedDelegate__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_TopDownRogueLite_OnInteractedDelegate__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_TopDownRogueLite_OnInteractedDelegate__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_TopDownRogueLite_OnInteractedDelegate__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_TopDownRogueLite_OnInteractedDelegate__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
void FOnInteractedDelegate_DelegateWrapper(const FMulticastScriptDelegate& OnInteractedDelegate, ATDRL_Character* InteractingCharacter)
{
	struct _Script_TopDownRogueLite_eventOnInteractedDelegate_Parms
	{
		ATDRL_Character* InteractingCharacter;
	};
	_Script_TopDownRogueLite_eventOnInteractedDelegate_Parms Parms;
	Parms.InteractingCharacter=InteractingCharacter;
	OnInteractedDelegate.ProcessMulticastDelegate<UObject>(&Parms);
}
...
void FOnPickedUpDelegate_DelegateWrapper(const FMulticastScriptDelegate& OnPickedUpDelegate, ATDRL_Character* InteractingCharacter)
{
	struct _Script_TopDownRogueLite_eventOnPickedUpDelegate_Parms
	{
		ATDRL_Character* InteractingCharacter;
...
void FOnDroppedDelegate_DelegateWrapper(const FMulticastScriptDelegate& OnDroppedDelegate, ATDRL_Character* InteractingCharacter)
{
	struct _Script_TopDownRogueLite_eventOnDroppedDelegate_Parms
	{
		ATDRL_Character* InteractingCharacter;
...
void FOnEquippedDelegate_DelegateWrapper(const FMulticastScriptDelegate& OnEquippedDelegate, ATDRL_Character* InteractingCharacter)
{
	struct _Script_TopDownRogueLite_eventOnEquippedDelegate_Parms
	{
		ATDRL_Character* InteractingCharacter;
...
void FOnHolsteredDelegate_DelegateWrapper(const FMulticastScriptDelegate& OnHolsteredDelegate, ATDRL_Character* InteractingCharacter)
{
	struct _Script_TopDownRogueLite_eventOnHolsteredDelegate_Parms
	{
		ATDRL_Character* InteractingCharacter;
	...
	DEFINE_FUNCTION(ATDRL_Item::execInteracted)
	{
		P_GET_OBJECT(ATDRL_Character,Z_Param_InteractingCharacter);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->Interacted_Implementation(Z_Param_InteractingCharacter);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(ATDRL_Item::execInteract)
	{
		P_GET_OBJECT(ATDRL_Character,Z_Param_InteractingCharacter);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(ATDRL_Item::execRemoveSkeletalMeshComponent)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->RemoveSkeletalMeshComponent();
		P_NATIVE_END;
	}
	...
	struct TDRL_Item_eventInteracted_Parms
	{
		ATDRL_Character* InteractingCharacter;
	};
	...
	static FName NAME_ATDRL_Item_Interacted = FName(TEXT("Interacted"));
	void ATDRL_Item::Interacted(ATDRL_Character* InteractingCharacter)
	{
		TDRL_Item_eventInteracted_Parms Parms;
		Parms.InteractingCharacter=InteractingCharacter;
		ProcessEvent(FindFunctionChecked(NAME_ATDRL_Item_Interacted),&Parms);
	}
	...
	void ATDRL_Item::StaticRegisterNativesATDRL_Item()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "Interact", &ATDRL_Item::execInteract },
			{ "Interacted", &ATDRL_Item::execInteracted },
			...
			{ "RemoveSkeletalMeshComponent", &ATDRL_Item::execRemoveSkeletalMeshComponent },
	...
	struct Z_Construct_UFunction_ATDRL_Item_Interact_Statics
	{
		struct TDRL_Item_eventInteract_Parms
		{
			ATDRL_Character* InteractingCharacter;
		};
		static const UECodeGen_Private::FObjectPropertyParams NewProp_InteractingCharacter;
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ATDRL_Item_Interact_Statics::NewProp_InteractingCharacter = { "InteractingCharacter", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(TDRL_Item_eventInteract_Parms, InteractingCharacter), Z_Construct_UClass_ATDRL_Character_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ATDRL_Item_Interact_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ATDRL_Item_Interact_Statics::NewProp_InteractingCharacter,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ATDRL_Item_Interact_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Items/TDRL_Item.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ATDRL_Item_Interact_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ATDRL_Item, nullptr, "Interact", nullptr, nullptr, sizeof(Z_Construct_UFunction_ATDRL_Item_Interact_Statics::TDRL_Item_eventInteract_Parms), Z_Construct_UFunction_ATDRL_Item_Interact_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ATDRL_Item_Interact_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ATDRL_Item_Interact_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ATDRL_Item_Interact_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ATDRL_Item_Interact()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ATDRL_Item_Interact_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_ATDRL_Item_Interacted_Statics
	{
		static const UECodeGen_Private::FObjectPropertyParams NewProp_InteractingCharacter;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ATDRL_Item_Interacted_Statics::NewProp_InteractingCharacter = { "InteractingCharacter", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(TDRL_Item_eventInteracted_Parms, InteractingCharacter), Z_Construct_UClass_ATDRL_Character_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ATDRL_Item_Interacted_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ATDRL_Item_Interacted_Statics::NewProp_InteractingCharacter,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ATDRL_Item_Interacted_Statics::Function_MetaDataParams[] = {
		{ "Category", "TDRL|Item|Input" },
		{ "DisplayName", "Interacted" },
		{ "Keywords", "Interacted TDRL" },
		{ "ModuleRelativePath", "Public/Items/TDRL_Item.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ATDRL_Item_Interacted_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ATDRL_Item, nullptr, "Interacted", nullptr, nullptr, sizeof(TDRL_Item_eventInteracted_Parms), Z_Construct_UFunction_ATDRL_Item_Interacted_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ATDRL_Item_Interacted_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ATDRL_Item_Interacted_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ATDRL_Item_Interacted_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ATDRL_Item_Interacted()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ATDRL_Item_Interacted_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_ATDRL_Item_RemoveSkeletalMeshComponent_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ATDRL_Item_RemoveSkeletalMeshComponent_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Items/TDRL_Item.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ATDRL_Item_RemoveSkeletalMeshComponent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ATDRL_Item, nullptr, "RemoveSkeletalMeshComponent", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00080400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ATDRL_Item_RemoveSkeletalMeshComponent_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ATDRL_Item_RemoveSkeletalMeshComponent_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ATDRL_Item_RemoveSkeletalMeshComponent()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ATDRL_Item_RemoveSkeletalMeshComponent_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bStaticInteractable_MetaData[];
#endif
		static void NewProp_bStaticInteractable_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bStaticInteractable;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ATDRL_Item_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ATDRL_Item_ClearItemGlobalTimer, "ClearItemGlobalTimer" }, // 3495314377
		...
		{ &Z_Construct_UFunction_ATDRL_Item_Interact, "Interact" }, // 4075890690
		{ &Z_Construct_UFunction_ATDRL_Item_Interacted, "Interacted" }, // 2533997376
		{ &Z_Construct_UFunction_ATDRL_Item_IsItemGlobalTimerOver, "IsItemGlobalTimerOver" }, // 2663274790
		...
		{ &Z_Construct_UFunction_ATDRL_Item_RemoveSkeletalMeshComponent, "RemoveSkeletalMeshComponent" }, // 450619367
		{ &Z_Construct_UFunction_ATDRL_Item_SecondaryAction, "SecondaryAction" }, // 413767341
		{ &Z_Construct_UFunction_ATDRL_Item_SetupSkeletalMeshComponent, "SetupSkeletalMeshComponent" }, // 1719727044
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATDRL_Item_Statics::NewProp_bStaticInteractable_MetaData[] = {
		{ "Category", "TDRL|Data|Item" },
		{ "Comment", "/* Is this Item static? \"Pickup\" will be disabled and \"Interaction\" will be used instead*/" },
		{ "ModuleRelativePath", "Public/Items/TDRL_Item.h" },
		{ "ToolTip", "Is this Item static? \"Pickup\" will be disabled and \"Interaction\" will be used instead" },
	};
#endif
	void Z_Construct_UClass_ATDRL_Item_Statics::NewProp_bStaticInteractable_SetBit(void* Obj)
	{
		((ATDRL_Item*)Obj)->bStaticInteractable = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ATDRL_Item_Statics::NewProp_bStaticInteractable = { "bStaticInteractable", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(uint8), sizeof(ATDRL_Item), &Z_Construct_UClass_ATDRL_Item_Statics::NewProp_bStaticInteractable_SetBit, METADATA_PARAMS(Z_Construct_UClass_ATDRL_Item_Statics::NewProp_bStaticInteractable_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ATDRL_Item_Statics::NewProp_bStaticInteractable_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATDRL_Item_Statics::NewProp_OnInteract_MetaData[] = {
		{ "Category", "TDRL|Item|Delegates" },
		{ "Comment", "/*Interact delegate*/" },
		{ "ModuleRelativePath", "Public/Items/TDRL_Item.h" },
		{ "ToolTip", "Interact delegate" },
	};
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_ATDRL_Item_Statics::NewProp_OnInteract = { "OnInteract", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ATDRL_Item, OnInteract), Z_Construct_UDelegateFunction_TopDownRogueLite_OnInteractedDelegate__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_ATDRL_Item_Statics::NewProp_OnInteract_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ATDRL_Item_Statics::NewProp_OnInteract_MetaData)) }; // 2696910703
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ATDRL_Item_Statics::NewProp_GlobalTimerCountdownHandle = { "GlobalTimerCountdownHandle", nullptr, (EPropertyFlags)0x0020080000000020, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ATDRL_Item, GlobalTimerCountdownHandle), Z_Construct_UScriptStruct_FTimerHandle, METADATA_PARAMS(Z_Construct_UClass_ATDRL_Item_Statics::NewProp_GlobalTimerCountdownHandle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ATDRL_Item_Statics::NewProp_GlobalTimerCountdownHandle_MetaData)) }; // 3633724737
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATDRL_Item_Statics::NewProp_SkeletalMesh_MetaData[] = {
		{ "Category", "TDRL|Item|Runtime" },
		{ "Comment", "/*Runtime skeletal mesh component. Will be spawned and used when the weapon is equipped. Leave clear if you want to use the default static mesh*/" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Items/TDRL_Item.h" },
		{ "ToolTip", "Runtime skeletal mesh component. Will be spawned and used when the weapon is equipped. Leave clear if you want to use the default static mesh" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ATDRL_Item_Statics::NewProp_SkeletalMesh = { "SkeletalMesh", nullptr, (EPropertyFlags)0x002008000008001c, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ATDRL_Item, SkeletalMesh), Z_Construct_UClass_USkeletalMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ATDRL_Item_Statics::NewProp_SkeletalMesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ATDRL_Item_Statics::NewProp_SkeletalMesh_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ATDRL_Item_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATDRL_Item_Statics::NewProp_bStaticInteractable,
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATDRL_Item_Statics::NewProp_OnInteract,
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATDRL_Item_Statics::NewProp_SkeletalMesh,
	};
	...
	struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Items_TDRL_Item_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Items_TDRL_Item_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ATDRL_Item, ATDRL_Item::StaticClass, TEXT("ATDRL_Item"), &Z_Registration_Info_UClass_ATDRL_Item, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATDRL_Item), 1483852236U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Items_TDRL_Item_h_4193717012(TEXT("/Script/TopDownRogueLite"),
		Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Items_TDRL_Item_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Items_TDRL_Item_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
