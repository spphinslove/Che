...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATDRL_ProjectileTrace_Statics::NewProp_TrailEffects_MetaData[] = {
		...
		{ "Comment", "// = TArray<TEnumAsByte<EObjectTypeQuery>>{ UEngineTypes::ConvertToObjectType(ECollisionChannel::ECC_WorldStatic), UEngineTypes::ConvertToObjectType(ECollisionChannel::ECC_WorldDynamic), UEngineTypes::ConvertToObjectType(ECollisionChannel::ECC_Pawn), UEngineTypes::ConvertToObjectType(ECollisionChannel::ECC_Destructible), UEngineTypes::ConvertToObjectType(ECollisionChannel::ECC_Vehicle), UEngineTypes::ConvertToObjectType(ECollisionChannel::ECC_PhysicsBody) };\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Projectile/TDRL_ProjectileTrace.h" },
	...
	struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Projectile_TDRL_ProjectileTrace_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Projectile_TDRL_ProjectileTrace_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ATDRL_ProjectileTrace, ATDRL_ProjectileTrace::StaticClass, TEXT("ATDRL_ProjectileTrace"), &Z_Registration_Info_UClass_ATDRL_ProjectileTrace, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATDRL_ProjectileTrace), 652761649U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Projectile_TDRL_ProjectileTrace_h_1428536178(TEXT("/Script/TopDownRogueLite"),
		Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Projectile_TDRL_ProjectileTrace_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Projectile_TDRL_ProjectileTrace_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
