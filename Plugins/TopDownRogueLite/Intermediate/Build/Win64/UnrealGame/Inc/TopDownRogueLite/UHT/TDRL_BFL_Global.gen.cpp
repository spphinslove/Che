...
// End Cross Module References
	...
	DEFINE_FUNCTION(UTDRL_BFL_Global::execGetTDRLHUD)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(ATDRL_HUD**)Z_Param__Result=UTDRL_BFL_Global::GetTDRLHUD(Z_Param_WorldContextObject);
		P_NATIVE_END;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTDRL_BFL_Global_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UTDRL_BFL_Global_GetTDRLHUD, "GetTDRLHUD" }, // 3251292058
	...
	UTDRL_BFL_Global::UTDRL_BFL_Global(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UTDRL_BFL_Global);
	UTDRL_BFL_Global::~UTDRL_BFL_Global() {}
	struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Gameplay_TDRL_BFL_Global_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Gameplay_TDRL_BFL_Global_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTDRL_BFL_Global, UTDRL_BFL_Global::StaticClass, TEXT("UTDRL_BFL_Global"), &Z_Registration_Info_UClass_UTDRL_BFL_Global, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTDRL_BFL_Global), 3076634552U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Gameplay_TDRL_BFL_Global_h_80628320(TEXT("/Script/TopDownRogueLite"),
		Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Gameplay_TDRL_BFL_Global_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Gameplay_TDRL_BFL_Global_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
