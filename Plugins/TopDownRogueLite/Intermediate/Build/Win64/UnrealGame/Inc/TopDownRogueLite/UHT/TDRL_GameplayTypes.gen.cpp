...
// End Cross Module References
	...
	static UEnum* EPlayersSapawnUnlockMethod_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EPlayersSapawnUnlockMethod.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_TopDownRogueLite_EPlayersSapawnUnlockMethod, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("EPlayersSapawnUnlockMethod"));
		}
	...
	static UEnum* EPlayersSapawnMethod_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EPlayersSapawnMethod.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_TopDownRogueLite_EPlayersSapawnMethod, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("EPlayersSapawnMethod"));
		}
	...
	static UEnum* EControlRotationType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EControlRotationType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_TopDownRogueLite_EControlRotationType, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("EControlRotationType"));
		}
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_TopDownRogueLite_EControlRotationType_Statics::Enumerators[] = {
		{ "EControlRotationType::UnderMouse", (int64)EControlRotationType::UnderMouse },
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_TopDownRogueLite_EControlRotationType_Statics::Enum_MetaDataParams[] = {
		...
		{ "UnderMouse.DisplayName", "UnderMouse" },
		{ "UnderMouse.Name", "EControlRotationType::UnderMouse" },
	};
#endif
...
class UScriptStruct* FDeathData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_DeathData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FDeathData, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("DeathData"));
	}
...
class UScriptStruct* FHitEffectType::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_HitEffectType.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHitEffectType, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("HitEffectType"));
	}
...
class UScriptStruct* FDashEffect::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_DashEffect.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FDashEffect, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("DashEffect"));
	}
...
class UScriptStruct* FStunParameters::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_StunParameters.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStunParameters, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("StunParameters"));
	}
...
class UScriptStruct* FStatusEffect::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_StatusEffect.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStatusEffect, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("StatusEffect"));
	}
...
class UScriptStruct* FCosmeticParameterList::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CosmeticParameterList.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCosmeticParameterList, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("CosmeticParameterList"));
	}
...
class UScriptStruct* FMergeSkeletalMeshesParameters::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MergeSkeletalMeshesParameters.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMergeSkeletalMeshesParameters, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("MergeSkeletalMeshesParameters"));
	}
...
class UScriptStruct* FCurrencyData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CurrencyData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCurrencyData, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("CurrencyData"));
	}
...
class UScriptStruct* FCurrenciesList::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CurrenciesList.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCurrenciesList, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("CurrenciesList"));
	}
...
template<> TOPDOWNROGUELITE_API UScriptStruct* StaticStruct<FCurrenciesList>()
{
	...
	struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_GameplayTypes_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_GameplayTypes_h_Statics::EnumInfo[] = {
		...
		{ EControlRotationType_StaticEnum, TEXT("EControlRotationType"), &Z_Registration_Info_UEnum_EControlRotationType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2392070471U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_GameplayTypes_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_GameplayTypes_h_2996252115(TEXT("/Script/TopDownRogueLite"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_GameplayTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_GameplayTypes_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_GameplayTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_GameplayTypes_h_Statics::EnumInfo));
