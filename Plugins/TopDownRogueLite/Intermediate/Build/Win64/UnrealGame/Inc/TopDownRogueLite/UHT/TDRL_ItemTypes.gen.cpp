...
// End Cross Module References
	...
	static UEnum* EItemRarity_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EItemRarity.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_TopDownRogueLite_EItemRarity, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("EItemRarity"));
		}
	...
	static UEnum* EItemInteractions_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EItemInteractions.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_TopDownRogueLite_EItemInteractions, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("EItemInteractions"));
		}
...
class UScriptStruct* FItemAbilitiesEffects::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ItemAbilitiesEffects.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FItemAbilitiesEffects, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("ItemAbilitiesEffects"));
	}
...
class UScriptStruct* FItemStaticData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ItemStaticData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FItemStaticData, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("ItemStaticData"));
	}
...
class UScriptStruct* FMeleePrimaryAttackMontages::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MeleePrimaryAttackMontages.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMeleePrimaryAttackMontages, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("MeleePrimaryAttackMontages"));
	}
...
class UScriptStruct* FMeleeStaticData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MeleeStaticData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMeleeStaticData, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("MeleeStaticData"));
	}
...
class UScriptStruct* FFirearmMontages::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FirearmMontages.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FFirearmMontages, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("FirearmMontages"));
	}
...
class UScriptStruct* FFirearmStaticData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FirearmStaticData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FFirearmStaticData, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("FirearmStaticData"));
	}
...
class UScriptStruct* FProjectileStaticData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ProjectileStaticData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FProjectileStaticData, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("ProjectileStaticData"));
	}
...
template<> TOPDOWNROGUELITE_API UScriptStruct* StaticStruct<FProjectileStaticData>()
{
	...
	struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_ItemTypes_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_ItemTypes_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_ItemTypes_h_Statics::ScriptStructInfo[] = {
		...
		{ FMeleeStaticData::StaticStruct, Z_Construct_UScriptStruct_FMeleeStaticData_Statics::NewStructOps, TEXT("MeleeStaticData"), &Z_Registration_Info_UScriptStruct_MeleeStaticData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMeleeStaticData), 1584764931U) },
		...
		{ FProjectileStaticData::StaticStruct, Z_Construct_UScriptStruct_FProjectileStaticData_Statics::NewStructOps, TEXT("ProjectileStaticData"), &Z_Registration_Info_UScriptStruct_ProjectileStaticData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FProjectileStaticData), 2675807444U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_ItemTypes_h_105690131(TEXT("/Script/TopDownRogueLite"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_ItemTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_ItemTypes_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_ItemTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_ItemTypes_h_Statics::EnumInfo));
