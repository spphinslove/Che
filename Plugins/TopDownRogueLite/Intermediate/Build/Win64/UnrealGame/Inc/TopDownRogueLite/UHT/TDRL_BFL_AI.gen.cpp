...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTDRL_BFL_AI_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UTDRL_BFL_AI_GetLocationFromActorOrVectorFromBB, "GetLocationFromActorOrVectorFromBB" }, // 3105505140
	};
#if WITH_METADATA
	...
	UTDRL_BFL_AI::UTDRL_BFL_AI(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UTDRL_BFL_AI);
	UTDRL_BFL_AI::~UTDRL_BFL_AI() {}
	struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_AI_TDRL_BFL_AI_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_AI_TDRL_BFL_AI_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTDRL_BFL_AI, UTDRL_BFL_AI::StaticClass, TEXT("UTDRL_BFL_AI"), &Z_Registration_Info_UClass_UTDRL_BFL_AI, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTDRL_BFL_AI), 2738799570U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_AI_TDRL_BFL_AI_h_737205369(TEXT("/Script/TopDownRogueLite"),
		Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_AI_TDRL_BFL_AI_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_AI_TDRL_BFL_AI_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
