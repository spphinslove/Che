...
void EmptyLinkFunctionForGeneratedCodeTopDownRogueLite_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_TopDownRogueLite()
	{
		if (!Z_Registration_Info_UPackage__Script_TopDownRogueLite.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_TopDownRogueLite_OnInteractedDelegate__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_TopDownRogueLite(Z_Construct_UPackage__Script_TopDownRogueLite, TEXT("/Script/TopDownRogueLite"), Z_Registration_Info_UPackage__Script_TopDownRogueLite, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x5FEB051E, 0xAD7C3DC1));
