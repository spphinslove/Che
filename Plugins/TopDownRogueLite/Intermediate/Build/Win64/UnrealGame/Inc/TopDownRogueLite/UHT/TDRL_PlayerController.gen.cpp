...
// End Cross Module References
	...
	DEFINE_FUNCTION(ATDRL_PlayerController::execSetLockedTarget)
	{
		P_GET_OBJECT(AActor,Z_Param_NewTarget);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SetLockedTarget(Z_Param_NewTarget);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(ATDRL_PlayerController::execGetLockedTarget)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(AActor**)Z_Param__Result=P_THIS->GetLockedTarget();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(ATDRL_PlayerController::execSetLocationTarget)
	{
		P_GET_STRUCT(FVector,Z_Param_TargetLocation);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SetLocationTarget(Z_Param_TargetLocation);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(ATDRL_PlayerController::execGetLocationTarget)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(FVector*)Z_Param__Result=P_THIS->GetLocationTarget();
		P_NATIVE_END;
	}
	...
	void ATDRL_PlayerController::StaticRegisterNativesATDRL_PlayerController()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "GetLocationTarget", &ATDRL_PlayerController::execGetLocationTarget },
			{ "GetLockedTarget", &ATDRL_PlayerController::execGetLockedTarget },
			...
			{ "SetLocationTarget", &ATDRL_PlayerController::execSetLocationTarget },
			{ "SetLockedTarget", &ATDRL_PlayerController::execSetLockedTarget },
	...
	struct Z_Construct_UFunction_ATDRL_PlayerController_GetLocationTarget_Statics
	{
		struct TDRL_PlayerController_eventGetLocationTarget_Parms
		{
			FVector ReturnValue;
		};
		static const UECodeGen_Private::FStructPropertyParams NewProp_ReturnValue;
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ATDRL_PlayerController_GetLocationTarget_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(TDRL_PlayerController_eventGetLocationTarget_Parms, ReturnValue), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ATDRL_PlayerController_GetLocationTarget_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ATDRL_PlayerController_GetLocationTarget_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ATDRL_PlayerController_GetLocationTarget_Statics::Function_MetaDataParams[] = {
		{ "Category", "TDRL|PlayerController" },
		{ "DisplayName", "Get Location Target" },
		{ "Keywords", "Get Location Target TDRL" },
		{ "ModuleRelativePath", "Public/Player/TDRL_PlayerController.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ATDRL_PlayerController_GetLocationTarget_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ATDRL_PlayerController, nullptr, "GetLocationTarget", nullptr, nullptr, sizeof(Z_Construct_UFunction_ATDRL_PlayerController_GetLocationTarget_Statics::TDRL_PlayerController_eventGetLocationTarget_Parms), Z_Construct_UFunction_ATDRL_PlayerController_GetLocationTarget_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ATDRL_PlayerController_GetLocationTarget_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54820400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ATDRL_PlayerController_GetLocationTarget_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ATDRL_PlayerController_GetLocationTarget_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ATDRL_PlayerController_GetLocationTarget()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ATDRL_PlayerController_GetLocationTarget_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_ATDRL_PlayerController_GetLockedTarget_Statics
	{
		struct TDRL_PlayerController_eventGetLockedTarget_Parms
		{
			AActor* ReturnValue;
		};
		static const UECodeGen_Private::FObjectPropertyParams NewProp_ReturnValue;
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ATDRL_PlayerController_GetLockedTarget_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(TDRL_PlayerController_eventGetLockedTarget_Parms, ReturnValue), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ATDRL_PlayerController_GetLockedTarget_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ATDRL_PlayerController_GetLockedTarget_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ATDRL_PlayerController_GetLockedTarget_Statics::Function_MetaDataParams[] = {
		{ "Category", "TDRL|PlayerController|AimOffset" },
		{ "DisplayName", "Get Locked Target" },
		{ "Keywords", "Get Locked Target TDRL" },
		{ "ModuleRelativePath", "Public/Player/TDRL_PlayerController.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ATDRL_PlayerController_GetLockedTarget_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ATDRL_PlayerController, nullptr, "GetLockedTarget", nullptr, nullptr, sizeof(Z_Construct_UFunction_ATDRL_PlayerController_GetLockedTarget_Statics::TDRL_PlayerController_eventGetLockedTarget_Parms), Z_Construct_UFunction_ATDRL_PlayerController_GetLockedTarget_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ATDRL_PlayerController_GetLockedTarget_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ATDRL_PlayerController_GetLockedTarget_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ATDRL_PlayerController_GetLockedTarget_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ATDRL_PlayerController_GetLockedTarget()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ATDRL_PlayerController_GetLockedTarget_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_ATDRL_PlayerController_SetLocationTarget_Statics
	{
		struct TDRL_PlayerController_eventSetLocationTarget_Parms
		{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ATDRL_PlayerController_SetLocationTarget_Statics::NewProp_TargetLocation_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ATDRL_PlayerController_SetLocationTarget_Statics::NewProp_TargetLocation = { "TargetLocation", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(TDRL_PlayerController_eventSetLocationTarget_Parms, TargetLocation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UFunction_ATDRL_PlayerController_SetLocationTarget_Statics::NewProp_TargetLocation_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_ATDRL_PlayerController_SetLocationTarget_Statics::NewProp_TargetLocation_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ATDRL_PlayerController_SetLocationTarget_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ATDRL_PlayerController_SetLocationTarget_Statics::NewProp_TargetLocation,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ATDRL_PlayerController_SetLocationTarget_Statics::Function_MetaDataParams[] = {
		{ "Category", "TDRL|PlayerController" },
		{ "DisplayName", "Set Location Target" },
		{ "Keywords", "Set Location Target TDRL" },
		{ "ModuleRelativePath", "Public/Player/TDRL_PlayerController.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ATDRL_PlayerController_SetLocationTarget_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ATDRL_PlayerController, nullptr, "SetLocationTarget", nullptr, nullptr, sizeof(Z_Construct_UFunction_ATDRL_PlayerController_SetLocationTarget_Statics::TDRL_PlayerController_eventSetLocationTarget_Parms), Z_Construct_UFunction_ATDRL_PlayerController_SetLocationTarget_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ATDRL_PlayerController_SetLocationTarget_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04820400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ATDRL_PlayerController_SetLocationTarget_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ATDRL_PlayerController_SetLocationTarget_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ATDRL_PlayerController_SetLocationTarget()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ATDRL_PlayerController_SetLocationTarget_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_ATDRL_PlayerController_SetLockedTarget_Statics
	{
		struct TDRL_PlayerController_eventSetLockedTarget_Parms
		{
			AActor* NewTarget;
		};
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ATDRL_PlayerController_SetLockedTarget_Statics::NewProp_NewTarget = { "NewTarget", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(TDRL_PlayerController_eventSetLockedTarget_Parms, NewTarget), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ATDRL_PlayerController_SetLockedTarget_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ATDRL_PlayerController_SetLockedTarget_Statics::NewProp_NewTarget,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ATDRL_PlayerController_SetLockedTarget_Statics::Function_MetaDataParams[] = {
		{ "Category", "TDRL|PlayerController|AimOffset" },
		{ "DisplayName", "Set Locked Target" },
		{ "Keywords", "Set Locked Target TDRL" },
		{ "ModuleRelativePath", "Public/Player/TDRL_PlayerController.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ATDRL_PlayerController_SetLockedTarget_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ATDRL_PlayerController, nullptr, "SetLockedTarget", nullptr, nullptr, sizeof(Z_Construct_UFunction_ATDRL_PlayerController_SetLockedTarget_Statics::TDRL_PlayerController_eventSetLockedTarget_Parms), Z_Construct_UFunction_ATDRL_PlayerController_SetLockedTarget_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ATDRL_PlayerController_SetLockedTarget_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ATDRL_PlayerController_SetLockedTarget_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ATDRL_PlayerController_SetLockedTarget_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ATDRL_PlayerController_SetLockedTarget()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ATDRL_PlayerController_SetLockedTarget_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_LocationTarget_MetaData[];
#endif
		static const UECodeGen_Private::FStructPropertyParams NewProp_LocationTarget;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ATDRL_PlayerController_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ATDRL_PlayerController_GetControlRotationType, "GetControlRotationType" }, // 2349372588
		{ &Z_Construct_UFunction_ATDRL_PlayerController_GetDefaultCharacterCosmetic, "GetDefaultCharacterCosmetic" }, // 3974633410
		{ &Z_Construct_UFunction_ATDRL_PlayerController_GetLocationTarget, "GetLocationTarget" }, // 1000976289
		{ &Z_Construct_UFunction_ATDRL_PlayerController_GetLockedTarget, "GetLockedTarget" }, // 2032657708
		...
		{ &Z_Construct_UFunction_ATDRL_PlayerController_SetControlRotationType, "SetControlRotationType" }, // 2980603207
		{ &Z_Construct_UFunction_ATDRL_PlayerController_SetLocationTarget, "SetLocationTarget" }, // 2867579936
		{ &Z_Construct_UFunction_ATDRL_PlayerController_SetLockedTarget, "SetLockedTarget" }, // 2240063844
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATDRL_PlayerController_Statics::NewProp_LocationTarget_MetaData[] = {
		{ "ModuleRelativePath", "Public/Player/TDRL_PlayerController.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ATDRL_PlayerController_Statics::NewProp_LocationTarget = { "LocationTarget", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ATDRL_PlayerController, LocationTarget), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_ATDRL_PlayerController_Statics::NewProp_LocationTarget_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ATDRL_PlayerController_Statics::NewProp_LocationTarget_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ATDRL_PlayerController_Statics::NewProp_AimOffsetUpdateTime = { "AimOffsetUpdateTime", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ATDRL_PlayerController, AimOffsetUpdateTime), METADATA_PARAMS(Z_Construct_UClass_ATDRL_PlayerController_Statics::NewProp_AimOffsetUpdateTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ATDRL_PlayerController_Statics::NewProp_AimOffsetUpdateTime_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ATDRL_PlayerController_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATDRL_PlayerController_Statics::NewProp_LocationTarget,
	...
	struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Player_TDRL_PlayerController_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Player_TDRL_PlayerController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ATDRL_PlayerController, ATDRL_PlayerController::StaticClass, TEXT("ATDRL_PlayerController"), &Z_Registration_Info_UClass_ATDRL_PlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATDRL_PlayerController), 3008097745U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Player_TDRL_PlayerController_h_54166419(TEXT("/Script/TopDownRogueLite"),
		Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Player_TDRL_PlayerController_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Player_TDRL_PlayerController_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
