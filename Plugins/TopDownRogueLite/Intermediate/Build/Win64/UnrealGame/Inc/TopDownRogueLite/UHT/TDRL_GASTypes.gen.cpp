...
// End Cross Module References
	...
	static UEnum* ETDRLGASAbilityInputID_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ETDRLGASAbilityInputID.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_TopDownRogueLite_ETDRLGASAbilityInputID, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("ETDRLGASAbilityInputID"));
		}
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_TopDownRogueLite_ETDRLGASAbilityInputID_Statics::Enumerators[] = {
		...
		{ "ETDRLGASAbilityInputID::Pickup", (int64)ETDRLGASAbilityInputID::Pickup },
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_TopDownRogueLite_ETDRLGASAbilityInputID_Statics::Enum_MetaDataParams[] = {
		...
		{ "Pickup.Name", "ETDRLGASAbilityInputID::Pickup" },
...
class UScriptStruct* FGASContainer::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GASContainer.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGASContainer, (UObject*)Z_Construct_UPackage__Script_TopDownRogueLite(), TEXT("GASContainer"));
	}
...
template<> TOPDOWNROGUELITE_API UScriptStruct* StaticStruct<FGASContainer>()
{
	...
	struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_GASTypes_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_GASTypes_h_Statics::EnumInfo[] = {
		{ ETDRLGASAbilityInputID_StaticEnum, TEXT("ETDRLGASAbilityInputID"), &Z_Registration_Info_UEnum_ETDRLGASAbilityInputID, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2193788424U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_GASTypes_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_GASTypes_h_1021574994(TEXT("/Script/TopDownRogueLite"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_GASTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_GASTypes_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_GASTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Types_TDRL_GASTypes_h_Statics::EnumInfo));
