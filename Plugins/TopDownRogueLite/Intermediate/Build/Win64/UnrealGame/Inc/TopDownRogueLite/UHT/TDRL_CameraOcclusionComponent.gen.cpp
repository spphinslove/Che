...
void FOnOcclusionChanged_DelegateWrapper(const FMulticastScriptDelegate& OnOcclusionChanged, bool Occluded, const TArray<USceneComponent*>& OcclusionComps)
{
	struct _Script_TopDownRogueLite_eventOnOcclusionChanged_Parms
	{
		bool Occluded;
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UTDRL_CameraOcclusionComponent_Statics::NewProp_VisibilityTimerHandle = { "VisibilityTimerHandle", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UTDRL_CameraOcclusionComponent, VisibilityTimerHandle), Z_Construct_UScriptStruct_FTimerHandle, METADATA_PARAMS(Z_Construct_UClass_UTDRL_CameraOcclusionComponent_Statics::NewProp_VisibilityTimerHandle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTDRL_CameraOcclusionComponent_Statics::NewProp_VisibilityTimerHandle_MetaData)) }; // 3633724737
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Gameplay_TDRL_CameraOcclusionComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Gameplay_TDRL_CameraOcclusionComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTDRL_CameraOcclusionComponent, UTDRL_CameraOcclusionComponent::StaticClass, TEXT("UTDRL_CameraOcclusionComponent"), &Z_Registration_Info_UClass_UTDRL_CameraOcclusionComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTDRL_CameraOcclusionComponent), 2112464856U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Gameplay_TDRL_CameraOcclusionComponent_h_4245583651(TEXT("/Script/TopDownRogueLite"),
		Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Gameplay_TDRL_CameraOcclusionComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TopDownRogueLite_Source_TopDownRogueLite_Public_Gameplay_TDRL_CameraOcclusionComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
